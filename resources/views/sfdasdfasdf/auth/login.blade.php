...
<head>
  ...
  <title>Login &mdash; sikadsis</title>
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="login-brand">
              <img src="https://sikadsis.com/uploads/bs1HpuWqHZVZJZTcM0Mpx6AWLyA9sI.webp" alt="logo" width="100" class="shadow-light">
            </div>
            ...
            <div class="simple-footer">
              {{ __('admin.Copyright') }} &copy; {{ __('sikadsis 2023') }}
            </div>
          </div>
        </div>
      </div>
