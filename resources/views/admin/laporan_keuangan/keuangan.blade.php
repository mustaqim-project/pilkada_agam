...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>{{ __('admin.Pembiayaan Keuangan') }}</h1>
        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('admin.laporan-keuangan.destroy', $laporan->id) }}"
                                            ...
                                            @csrf
                                            @method('DELETE')
                                            <button class="btn btn-danger delete-item" type="submit"
                                                >Hapus</button>
                                        </form>
                                    </td>
                                </tr>
    ...
    <div class="modal fade" id="editModalLapKeu" tabindex="-1" role="dialog" aria-labelledby="editModalLapKeuLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
