...
@section('content')
    ...
    <!-- Modal Tambah Wisata -->
    <div class="modal fade" id="modalTambahWisata" tabindex="-1" aria-labelledby="modalTambahWisataLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('admin.timwisata.admin.kecematan.storeWisata') }}" method="POST"
    ...
    <!-- Modal Edit Wisata -->
    <div class="modal fade" id="modalEditWisata" tabindex="-1" aria-labelledby="modalEditWisataLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
