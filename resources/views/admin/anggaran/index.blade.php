...
@section('content')
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-warning" data-toggle="modal"
                                            data-target="#modalEditAnggaran" data-id="{{ $anggaran->id }}">
                                            Edit
                                        </button>
                                        ...
                                        <form action="{{ route('admin.anggaran.destroy', $anggaran->id) }}" method="POST"
                                            ...
                                            <button type="submit" class="btn btn-danger"
                                                onclick="return confirm('Yakin ingin menghapus anggaran ini?')">Hapus</button>
                                        </form>
                                    </td>
                                </tr>
                            @endforeach
    ...
    <div class="modal fade" id="modalTambahAnggaran" tabindex="-1" aria-labelledby="modalTambahAnggaranLabel"
        aria-hidden="true">
    ...
    <!-- Modal Edit Anggaran -->
    <div class="modal fade" id="modalEditAnggaran" tabindex="-1" aria-labelledby="modalEditAnggaranLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="formEditAnggaran" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="total_anggaran" id="edit_total_anggaran" class="form-control"
                                required>
                        </div>
                        <div class="form-group">
                            <label for="edit_jumlah_periode" class="form-label">Jumlah Periode</label>
                            <input type="number" name="jumlah_periode" id="edit_jumlah_periode" class="form-control"
                                required>
                        </div>
                    </div>
                    <div class="modal-footer">
