    ...
    <div class="form-group">
        ...
        @enderror
                ...
                <div class="input-style has-icon input-style-1 mt-4">
                    <span>Longitude</span>
                    <em>(*Wajib Diisi)</em>
                    <x-text-input id="longitude" class="input" type="text" name="longitude" readonly :value="old('longitude')" />
                    <x-input-error :messages="$errors->get('longitude')" class="mt-2" />
                </div>
                <div class="input-style has-icon input-style-1 mt-4">
                    <span>Latitude</span>
                    <em>(*Wajib Diisi)</em>
                    <x-text-input id="latitude" class="input" type="text" name="latitude" readonly :value="old('latitude')" />
