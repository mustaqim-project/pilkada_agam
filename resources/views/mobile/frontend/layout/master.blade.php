...
<head>
    ...
    <style>
        ...
        body {
            max-width: 1024px;
            /* Ukuran maksimal tablet dalam piksel */
            margin: 0 auto;
            /* Menengahkan tampilan di layar lebih lebar */
        }
        ...
        @media (max-width: 1024px) {
            body {
                max-width: 100%;
                /* Sesuaikan dengan lebar layar perangkat */
            }
        }
    </style>
...
<script>
    Swal.fire({
        ...
        timer: 3000,  // Timer dalam milidetik, SweetAlert akan otomatis hilang setelah 3 detik
