<div class="card card-style mb-0">
    <a href="#" class="footer-title pt-4">SIKADSIS</a>
    ...
    <p class="footer-copyright pb-3 mb-1">Copyright &copy; SIKADSIS <span id="copyright-year">2024</span>. All Rights Reserved.</p>
</div>
