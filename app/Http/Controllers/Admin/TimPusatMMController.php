...
class TimPusatMMController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.timpusatmm.index', compact('laporanPembayaran', 'totalKeseluruhan', 'jumlahPerPeriode'));
    }

    public function create()
    {
        // Logika untuk menampilkan form pembuatan data keuangan
        return view('admin.timpusatmm.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.timpusatmm.index')->with('success', 'Data keuangan berhasil dibuat.');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.timpusatmm.edit', compact('data')); // Kirim data ke view
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.timpusatmm.index')->with('success', 'Data keuangan berhasil diperbarui.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.timpusatmm.index')->with('success', 'Data keuangan berhasil dihapus.');
    }
}
